...
- Field supervisor / subcontractor is not a party and cannot change price, scope, or schedule.

## Property (legal description only)
Lot 16, Block 8, Teton Heights Division 6, Jefferson County, Idaho (Deed Instrument No. 501245)
Owner already owns the Property. This package is construction only.
Plans: River Bend Drafting — *Lauren and Cindy Holwege 8-31-2026b* (Elise Shurtliff)

## Locked dollars (CONFIRMED in package)
- Cost of work: $599,391.00
- Owner contingency 5%: $29,969.55 (not advanced on Draws 1–5)
- Split Rock P&O 10%: $59,939.10
- **Construction contract: $689,299.65**
- Draw base Draws 1–5: $659,330.10
- No lot purchase price in this contract.

## Draw schedule (payee = Split Rock Construction LLC only)
...
## Packet contents
01 I.C. § 45-525(2) initial disclosure — sign before work
02 I.C. § 45-525(3) sub list — fill before Draw 6 (blank now)
03 Construction agreement — dual-capacity is §13
04 Key specifications from 8/31 plans
05 Exhibit B cost stack
06 One-pager
07 Why this is not a pre-sold / RE-22
08 Dual-capacity excerpt (SoT is agreement §13)
09 Permit field sheet (not a filed permit)
