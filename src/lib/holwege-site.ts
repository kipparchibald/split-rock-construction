...
/** Public asset: extracted PLOT PLAN / P-8 from the River Bend plan set */
export const HOLWEGE_PLOT_PLAN_IMAGE_URL =
  "/holwege/Holwege-Lot16-PLOT-PLAN-8.jpg";
export const HOLWEGE_PLOT_PLAN_PDF_URL =
  "/holwege/Holwege-Lot16-PLOT-PLAN.pdf";
